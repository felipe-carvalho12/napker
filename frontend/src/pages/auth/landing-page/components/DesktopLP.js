...
export default function DesktopLP() {
    ...
    return (
        <div className="d-flex flex-column align-items-center c-b-12" style={{ background: 'var(--p-g)', height: "100%", width: "100vw" }}>
            ...
            <div
                className="d-flex position-sticky flex-column w-100 vh-100 justify-content-between"
                style={{ top: '-100px', left: '0', zIndex: '0', color: 'var(--b-09)' }}
            >
                <Wave colors={["var(--w-06)", "var(--w-06)", "var(--w-06)", "var(--w-12)"]} />
                <div 
                    className="d-flex h-100 w-100 justify-content-between align-item-center"
                    style={{ background: "rgba(255, 255, 255)", padding: "0 12.5%" }}
                >
                    <div
                        style={{ width: "40%" }} 
                        className="mx-5"
            ...
            <div
                className="position-sticky d-flex w-100 vh-100 blur-sat0-20px justify-content-between b-t"
                style={{ top: '49px', left: '0', zIndex: '1', color: 'var(--b-09)', background: "rgba(255, 255, 255, 0.88)", padding: "50px 12.5%" }}
            >
                <div
                    style={{ width: "40%" }} 
                    className="mx-5"
            ...
            <div
                className="position-sticky d-flex w-100 vh-100 blur-sat0-20px justify-content-between b-t"
                style={{ top: '49px', left: '0', zIndex: '2', color: 'var(--b-09)', background: "rgba(255, 255, 255, 0.88)", padding: "50px 12.5%" }}
            >
                <div 
                    className="mx-5"
                    style={{ width: "40%" }} 
