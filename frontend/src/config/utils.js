...
export const setTheme = () => {
  ...
  if (theme === 'light') {
    ...
    cssVariables.setProperty('--border-color'               ,                 'var(--w-08)', 'light')
    cssVariables.setProperty('--b-c'                        ,                 'var(--b-04)', 'light')
    cssVariables.setProperty('--b-w-10'                     ,                 'var(--w-10)', 'light')
    cssVariables.setProperty('--b-w-11'                     ,                 'var(--w-11)', 'light')
    cssVariables.setProperty('--b-w-12'                     ,                 'var(--w-12)', 'light')
    cssVariables.setProperty('--heart-color'                ,                     '#E0245E', 'light')
    cssVariables.setProperty('--heart-background-hover'     ,       'rgba(224, 36, 94, .1)', 'light')
    cssVariables.setProperty('--loader-background'          ,     'rgba(119, 147, 125, .3)', 'light')
    cssVariables.setProperty('--tertiary-grey'              ,                     '#f2f2f2', 'light')
    cssVariables.setProperty('--view-more-select-border'    ,           'rgba(0, 0, 0, .2)', 'light')
    cssVariables.setProperty('--img-background'             ,           'rgba(0, 0, 0, .9)', 'light')
    cssVariables.setProperty('--img-background-hover'       ,           'rgba(0, 0, 0, .8)', 'light')
    ...
    cssVariables.setProperty('--border-color'               ,                 'var(--w-00)', 'dark')
    cssVariables.setProperty('--b-c'                        ,                 'var(--w-04)', 'dark')
    cssVariables.setProperty('--b-w-10'                     ,                 'var(--b-10)', 'dark')
    cssVariables.setProperty('--b-w-11'                     ,                 'var(--b-11)', 'dark')
    cssVariables.setProperty('--b-w-12'                     ,                 'var(--b-12)', 'dark')
    cssVariables.setProperty('--heart-color'                ,                     '#E0245E', 'dark')
    cssVariables.setProperty('--heart-background-hover'     ,       'rgba(224, 36, 94, .1)', 'dark')
    cssVariables.setProperty('--loader-background'          ,     'rgba(119, 147, 125, .3)', 'dark')
    cssVariables.setProperty('--tertiary-grey'              ,                     '#202020', 'dark')
    cssVariables.setProperty('--view-more-select-border'    ,     'rgba(255, 255, 255, .2)', 'dark')
    cssVariables.setProperty('--img-background'             ,           'rgba(0, 0, 0, .3)', 'dark')
    cssVariables.setProperty('--img-background-hover'       ,           'rgba(0, 0, 0, .3)', 'dark')
  }
}
